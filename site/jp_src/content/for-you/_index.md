...
ogDescription: "SmartGit が、単一開発者、チーム、DevOps、Git 初心者、パワー ユーザー、企業、コマンドライン ファン、オープンソース貢献者、教育機関などの役割にどのように適応するかをご覧ください。自分の道を選択し、最も重要なことのロックを解除しましょう。"
...
userRoles:
  ...
  - name: "DevOps Engineers"
    desc: "ユーザーに合わせて拡張できるように設計されています。 SmartGit を CI/CD パイプラインに統合し、複雑な分岐戦略を管理し、リポジトリを制御します。"
